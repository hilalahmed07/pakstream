        ...
        {patches.map((patch) => (
          ...
          >
            ...
            <div className="p-6 flex-grow">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3 overflow-hidden">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-lg truncate group-hover:text-accent transition-colors" style={{
              ...
              {/* Description */}
              <p className="text-sm mb-4 line-clamp-3 h-15" style={{ color: 'var(--color-text-secondary)' }}>
                {patch.description}
              </p>
