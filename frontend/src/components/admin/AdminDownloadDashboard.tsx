...
const AdminDownloadDashboard: React.FC = () => {
  ...
  // Filters — User ID and Asset ID lookups were dropped per UX feedback.
  ...
  }, [currentPage, limit, assetTypeFilter, startDate, endDate, sortBy, sortOrder]);
              ...
              <table className="w-full">
                <thead style={{ backgroundColor: 'var(--color-hover)' }}>
                  <tr>
                    ...
                    >
                      Username {sortBy === 'user' && (sortOrder === 'asc' ? '↑' : '↓')}
                    </th>
                    <th
                      className="px-4 py-3 text-left text-xs font-medium uppercase cursor-pointer hover:opacity-80"
                      style={{ color: 'var(--color-text-secondary)' }}
                    ...
                    >
                      Download Type {sortBy === 'assetType' && (sortOrder === 'asc' ? '↑' : '↓')}
                    </th>
                    <th
                      className="px-4 py-3 text-left text-xs font-medium uppercase cursor-pointer hover:opacity-80"
                      style={{ color: 'var(--color-text-secondary)' }}
