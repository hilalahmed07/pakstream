...
const AppContent: React.FC = () => {
  ...
  // Server-driven sign-out: another browser/tab signed in with this admin
  // account, so the backend evicts this session. Tear down auth locally and
  // surface a professional notice instead of letting the socket die silently.
  React.useEffect(() => {
    ...
    socketService.on('force-logout', handler);
    return () => {
      socketService.off('force-logout', handler);
    };
  }, [logout]);
